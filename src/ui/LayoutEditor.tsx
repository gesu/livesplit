      ...
      <div className="layout-editor-outer">
        <div className="layout-editor-inner-container">
          <div className="layout-editor-inner">
            <div className="btn-group">
              <button
                ...
                className={
                  this.state.editor.buttons.can_remove ? "" : "disabled"
                }
              >
              ...
              <button
                ...
                className={
                  this.state.editor.buttons.can_move_up ? "" : "disabled"
                }
              >
              ...
              <button
                ...
                className={
                  this.state.editor.buttons.can_move_down ? "" : "disabled"
                }
              >
          ...
          <div className="tab-bar layout-editor-tabs">
            <button
              className={
                "toggle-left" +
                (!this.state.showComponentSettings ? " button-pressed" : "")
              }
              onClick={(_) => {
                this.setState({
                  ...this.state,
        ...
        <div className="layout-container">
          <DragAutoRefreshLayout
            getState={() =>
              this.props.timer.readWith((t) =>
                this.props.editor.layoutStateAsJson(t)
              )
            }
