                ...
                <div>
                    ...
                    >
                        <AutoRefreshLayout
                            getState={() =>
                                this.readWith(t =>
                                    this.props.layout.updateStateAsJson(this.props.layoutState, t),
                                )
                            }
                ...
                <div className='sidebar-buttons'>
                    ...
                    <div className='small'>
                        <button
                            ...
                            className={
                                (this.state.timingMethod === TimingMethod.RealTime
                                    ? 'button-pressed'
                                    : '') + ' toggle-left'
                            }
                        >
                        ...
                        <button
                            ...
                            className={
                                (this.state.timingMethod === TimingMethod.GameTime
                                    ? 'button-pressed'
                                    : '') + ' toggle-right'
                            }
                        >
                    ...
                    <div className='connectkit-container'>
                        <ConnectKitButton />
                    </div>
                </div>
            </AutoRefresh>
    ...
    private updateSidebar() {
        if (this.props.sidebarOpen || this.props.isDesktop) {
            const [comparison, timingMethod] = this.props.timer.readWith((t): [string, number] => {
                return [t.currentComparison(), t.currentTimingMethod()];
            });
            ...
            if (typeof e.data === 'string') {
                ...
                switch (command) {
                    ...
                    case 'initgametime':
                        ...
                        break;
                    case 'setgametime':
                        this.setGameTime(args[0]);
                        break;
                    case 'setloadingtimes':
                        this.setLoadingTimes(args[0]);
                        break;
                    case 'pausegametime':
                        this.pauseGameTime();
                        break;
